...
{
#ifdef SCAN_DEBUG
  qDebug()<<__FILE__<<__LINE__<<"m_hTwainDLL ="<<m_hTwainDLL<<"m_pDSMProc ="<<m_pDSMProc;
#endif
...
#ifdef SCAN_DEBUG
  qDebug()<<__FILE__<<__LINE__<<"m_bSourceSelected ="<<m_bSourceSelected;
#endif
  return m_bSourceSelected;
}
/*
...
{
#ifdef SCAN_DEBUG
  qDebug()<<__FILE__<<__LINE__<<"m_bDSMOpen ="<<m_bDSMOpen;
#endif
...
{
#ifdef SCAN_DEBUG
  qDebug()<<__FILE__<<__LINE__<<"m_bDSOpen ="<<m_bDSOpen;
#endif
...
{
#ifdef SCAN_DEBUG
  qDebug()<<__FILE__<<__LINE__<<"CTwain::ProcessMessage";
  qDebug()<<__FILE__<<__LINE__<<SourceEnabled();
#endif
  if(SourceEnabled())
  {
...
#ifdef SCAN_DEBUG
      qDebug()<<__FILE__<<__LINE__<<"ret_value ="<<ret_value;
#endif
      GlobalFree(twCap.hContainer);
    }
    return ret_value;
...
#ifdef SCAN_DEBUG
    qDebug()<<__FILE__<<__LINE__<<"m_nImageCount ="<<m_nImageCount;
#endif
    return true;
  }
  else
